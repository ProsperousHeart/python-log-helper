...
func_wrapper = ConfiguredLogger.func_wrapper
...
@func_wrapper
def warning_test(log_obj:logging.Logger) -> None:
    """
    Function to show usage for WARNING logging.
    """
    print("HANDLERS:\t", log_obj.handlers)
...
if __name__ == "__main__":
    ...
    with ConfiguredLogger(file_name="Ext_Test_With_Class",
